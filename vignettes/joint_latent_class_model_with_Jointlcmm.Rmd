...
```{r, include=T,eval=TRUE, fig.height=6, fig.width=7, fig.align = "center"}
# residuals
plot(mj2)
```

```{r, include=T,eval=TRUE, fig.height=4, fig.width=5, fig.align = "center"}
...
```{r, include=T,message=F,eval=TRUE}
...
```{r, include=T,message=F, fig.height=4, fig.width=7, fig.align = "center"}
