...
We can obtain the classification and posterior class-membership probabilities using the predictClass function.
Using the 2-classes model estimated above, the posterior probabilities and classfication of the second subject of the paquid sample are obtained like that :
...
We can also obtain the predictions of the random-effects with the predictRE function :
...
For hlme models only we obtain subject specific predictions using the predictY function with option marg=FALSE :
