...
https://cran.r-project.org/web/package=lcmm/vignettes/latent_class_model_with_hlme.html
...
This is detailed in vignette on pre-normalizing:  https://cran.r-project.org/web/package=lcmm/vignettes/pre_normalizing.html
