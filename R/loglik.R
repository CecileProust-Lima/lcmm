...
#' @param weight0 the optional individual sampling weights (dim ns0)
...
loglikhlme <- function(b,Y0,X0,weight0,prior0,pprior0,idprob0,idea0,idg0,idcor0,
