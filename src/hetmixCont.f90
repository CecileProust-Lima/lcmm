...
! FIN BOUCLE SUJET
 ...
 654  continue
      ...
      subroutine logliklcmmcont(Y0,X0,Prior0,pprior0,idprob0,idea0,idg0,idcor0,ns0,ng0,nv0, &
...
! fin en prevision
      ...
      ,idea(nv0),idg(nv0),idcor(nv0),nmes(ns0),prior(ns0),pprior(ns0,ng0))
...
!      write(*,*)'avant deallocate'
 ...
 1589 continue
      ...
      deallocate(Y,X,idprob,idea,idg,idcor,nmes,prior,pprior)
