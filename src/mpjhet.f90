...
!!$  contrainte : type de parametrisation (0=hlme, 1=lcmm, 2=multlcmm)
    ...
    subroutine mpjhet(K0,ny0,nbevt0,ng0,ns0,Y0,nobs0,X0,nv0,Xns0,nv20, &
         ...
         nmes0,nea0,nw0,ncor0,nalea0,idiag0,int3, &
      ...
      integer,intent(in)::K0,nbevt0,ns0,ng0,nv20,nobs0,npmtot0,nsim,contrainte0
      integer,dimension(K0)::ny0,nv0,nea0,nw0,ncor0,nalea0,idiag0
      integer,dimension(ns0,sum(ny0(:)))::nmes0   
      integer,dimension(3),intent(in)::int3
      ...
      !jac1=0.d0
      !jac2=0.d0
      call marq98(b,npm,ni,v,vrais,ier,istop,ca,cb,dd,vrais_mpj)
