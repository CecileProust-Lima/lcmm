...
!print*,nprob,nrisqtot,nvarxevt,nef,nvc,nwg,ncor,ntrtot
      ...
      vrais_surv=0.d0
      call marq98(b,npm,ni,v,vrais,ier,istop,ca,cb,dd,vrais_comp)
...
!!$            id=0
!!$            thi=0.d0
!!$            call vrais_discret_comp(b,npm,id,thi,id,thi,vraisdiscret)
!!$!               write(*,*)'vrais_discret',vraisdiscret
!!$
!!$            call vrais_cont_comp(b,npm,id,thi,id,thi,vraisdiscret)
